...
{
    public partial class ApproveConsensusListForm : XtraForm
    {
        public ApproveConsensusListForm()
        {
            InitializeComponent();
        }
...
FROM Consensus
    ...
    ", webData.Rows[0]["SQLConnectString"].ToString());
        ...
        WHERE CustomerID = {webCustomerIDValue} AND ResponseMessage LIKE '%Onaylandı%'
    ", webData.Rows[0]["SQLConnectString"].ToString());
            ...
            var result = from consensusRow in dt.AsEnumerable()
                         ...
                         select new
                         {
                             ...
                             OnaylayanKişi = webMatched.Field<string>("ResponsePerson"),
        ...
        private async void ApproveConsensusListForm_Load(object sender, EventArgs e)
        {
        ...
        private void excelToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                using (SaveFileDialog saveDialog = new SaveFileDialog())
                {
                    ...
                    saveDialog.FileName = "OnaylananMutabakatlar.xlsx";
        ...
        private void allUnSelectToolStripMenuItem_Click(object sender, EventArgs e)
        {
            for (int i = 0; i < gridView1.RowCount; i++)
        ...
        private void ApproveConsensusListForm_FormClosed(object sender, FormClosedEventArgs e)
        {
