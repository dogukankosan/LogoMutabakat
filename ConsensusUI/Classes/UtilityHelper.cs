...
namespace ConsensusUI.Classes
{
    internal class UtilityHelper
    {
        ...
        internal static string ImageToBase64(Image image, ImageFormat format)
        {
            ...
            {
                TextLog.TextLogging("ImageToBase64 Error: " + ex.Message + " --- " + ex.ToString(),"1");
                return null;
            }
        }
        internal static Image Base64ToImage(string base64String)
        {
            ...
            {
                TextLog.TextLogging("Base64ToImage Error: " + ex.Message + " --- " + ex.ToString(),"1");
                return null;
            }
        }
        internal static void CustomizeGridView(GridView gridView)
        {
